...
| Ошибка подключения к БД | Проверьте, что PostgreSQL запущен и данные в `.env` верны |
| Порт занят | Измените `SERVER_PORT` в файле `.env` |

### Учетные данные администратора

- **Логин**: `admin`
- **Пароль**: `adminpassword`
- **Email**: `neverov.andrey11102006@gmail.com`
